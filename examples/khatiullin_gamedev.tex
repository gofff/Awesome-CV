...
\name{Aidar}{Khatiullin}
\position{Senior C++ Software Engineer}
\address{Novi Sad, Serbia \& Remote}

%\mobile{(+82) 10-9030-1843}
\email{khatiullin@gmail.com}
%\dateofbirth{May, 1994}
...
%-------------------------------------------------------------------------------
\input{resume/summary_gamedev.tex}
\input{cv/skills_gamedev.tex}
\input{resume/experience_gamedev.tex}
